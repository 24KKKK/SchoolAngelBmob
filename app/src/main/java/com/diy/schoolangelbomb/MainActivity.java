        ...
        query.findObjects(new FindListener<Order>()
        {
            ...
            public void done(List<Order> list, BmobException e)
            {
                if (e == null)
                {
                    ...
                    L.i("从界面获得的数据：", strApart + "  " + strDormitory + "  " + strName + "  " + strFoodNum);
                    //判断一下为空
                    if (strApart.equals(""))
                    {
